...
from uav_benchmark.algorithms.ra_nsga2 import run_ra_nsga2
...
class RANSGA2FleetSmokeTest(unittest.TestCase):
    def test_fleet_ra_nsga2_writes_artifacts_and_rl_trace(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            params = BenchmarkParams(
                ...
                problem_name="smoke_ra_nsga2_uav3",
                problem_index=1,
                mode="fleet",
                fleet_size=3,
                separation_min=10.0,
            ...
            run_ra_nsga2(multi, params)
            run_dir = Path(tmpdir) / "smoke_ra_nsga2_uav3" / "Run_1"
